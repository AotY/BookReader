...
public abstract class Filter {
	...
	public final static class ByAuthor extends Filter {
		...
		public boolean matches(AbstractBook book) {
			...
			return
				com.koolearn.kooreader.book.Author.NULL.equals(Author) ? bookAuthors.isEmpty() : bookAuthors.contains(Author);
		}
	}
	...
	public final static class ByTag extends Filter {
		...
		public boolean matches(AbstractBook book) {
			...
			return
				com.koolearn.kooreader.book.Tag.NULL.equals(Tag) ? bookTags.isEmpty() : bookTags.contains(Tag);
		}
	}
