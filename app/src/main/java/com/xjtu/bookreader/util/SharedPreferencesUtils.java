...
public class SharedPreferencesUtils {
    ...
    private static SharedPreferences getSharedPreference(String fileName) {
        return BookReaderApplication.getInstance().getSharedPreferences(fileName, Context.MODE_PRIVATE);
    }
    ...
    public static boolean getNightMode() {
        return SharedPreferencesUtils.getBoolean(Constants.KEY_MODE_NIGHT, false);
    }

    public static void setNightMode(boolean nightMode) {
        SharedPreferencesUtils.putBoolean(Constants.KEY_MODE_NIGHT, nightMode);
    }
